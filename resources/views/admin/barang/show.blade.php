...
@section('title', 'Detail Barang - ' . $product->NM_BRG)
...
<div class="section-head" style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:12px;">
    ...
    <div style="display:flex;gap:8px;">
        <a href="{{ route('admin.products.edit', $product->KD_BRG) }}" class="button button-soft">✏ Edit Barang</a>
        <form action="{{ route('admin.products.destroy', $product->KD_BRG) }}" method="POST"
              onsubmit="return confirm('Hapus barang ini? Tindakan tidak dapat dibatalkan.');">
            @csrf
            @method('DELETE')
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;align-items:start;">
    {{-- KOLOM KIRI: Identitas & Satuan & Harga --}}
