<aside class="sidebar" id="sidebar">
    ...
    <nav class="nav-menu">
        ...
        <a href="{{ route('kunjungan') }}" class="{{ request()->routeIs('kunjungan') || request()->routeIs('checkin') || request()->routeIs('order') || request()->routeIs('pembayaran') ? 'active' : '' }}">
        ...
        <a href="{{ route('stok') }}" class="{{ request()->routeIs('stok') ? 'active' : '' }}">
